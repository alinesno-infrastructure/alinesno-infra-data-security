<template>
	<div class="app-container">
		...
		<el-dialog title="添加客户端" v-model="dialogFormVisible" width="40%" :close-on-click-modal="false">
			<el-table  :data="clientTableData" style="width: 100%">
				...
				<el-table-column label="操作" width="60">
					<template #default="scope">
						<el-button  circle icon="Plus" type="success" title="添加" @click="handleAddRegClient(scope.row)"></el-button>
					</template>
				</el-table-column>
			</el-table>
					...
					<div class="clearfix">
						...
						<span style="margin-left: 50px;">
							...
							<span style="font-size: 11pt;">
								...
								<el-tag  type="warning" style="font-weight: bold;">{{form.id}}</el-tag> - 
								<el-tag  type="success" style="font-weight: bold;">{{form.uri}}</el-tag>
							</span>
						</span>
						<div style="float: right; margin-left: 10px;">
						    <el-button icon="CirclePlus" type="success" @click="search" title="查找客户端">添加客户端</el-button>
						</div>
						<div style="float: right; margin-left: 10px;">
									...
									<div style="font-size: 10pt; width:500px;">
											...
											<div>
												...
												<div style="float: right; margin-left: 10px;">
													...
													<el-button icon="CopyDocument" type="success" @click="handleCopyToken()">复制令牌</el-button>
													<!-- <el-button icon="CircleClose " type="" @click="handleCloseToken(scope.$index)">关闭</el-button> -->
												</div>
