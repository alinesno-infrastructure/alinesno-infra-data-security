<template>
	<div style="margin:-20px;">
		...
		<el-row :gutter="24" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.uri}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;" v-if="infoForm.method != undefined && infoForm.method != ''">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.method}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;">
			<el-col :span="6" class="gateway-info-label">断言路径:</el-col>
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.path}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" v-if="infoForm.host != undefined && infoForm.host != ''" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.host}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" v-if="infoForm.remoteAddr != undefined && infoForm.remoteAddr != ''" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.remoteAddr}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" v-if="infoForm.header != undefined && infoForm.header != ''" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">{{infoForm.header}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;">
			<el-col :span="6" class="gateway-info-label">断言截取:</el-col>
			<el-col :span="18" class="gateway-info-value"><el-tag type="success">StripPrefix={{infoForm.stripPrefix}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;">
			<el-col :span="6" class="gateway-info-label">请求参数:</el-col>
			<el-col :span="18" class="gateway-info-value" :title="infoForm.requestParameter"><el-tag type="success">RequestParameter={{infoForm.requestParameter}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" v-if="infoForm.rewritePath != undefined && infoForm.rewritePath != ''" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value" :title="infoForm.rewritePath"><el-tag type="success">{{infoForm.rewritePath}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;" v-if="infoForm.filterGatewaName != undefined && infoForm.filterGatewaName != ''">
			...
			<el-col :span="18" class="gateway-info-value">
				<el-tag v-if="infoForm.filterGatewaName.indexOf('ip') != -1" type="warning">IP</el-tag>
				<el-tag v-if="infoForm.filterGatewaName.indexOf('token') != -1" type="warning">TOKEN</el-tag>
				<el-tag v-if="infoForm.filterGatewaName.indexOf('id') != -1" type="warning">ID</el-tag>
			</el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;" v-if="infoForm.filterHystrixName != undefined && infoForm.filterHystrixName != ''">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="warning">{{infoForm.filterHystrixName}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;" v-if="infoForm.filterRateLimiterName != undefined && infoForm.filterRateLimiterName != ''">
			...
			<el-col :span="18" class="gateway-info-value">
				<el-tag type="warning">{{infoForm.filterRateLimiterName}}</el-tag>
			</el-col>
		</el-row>
			...
			<el-col :span="18" class="gateway-info-value">
				<el-collapse accordion>
				  <el-collapse-item v-if="infoForm.filterAuthorizeName.indexOf('header') != -1">
					  <template #title>
						  <el-tag type="warning">HEADER验证</el-tag>
					  </template>
					<div><el-tag  type="">{{infoForm.accessHeader}}</el-tag></div>
				  </el-collapse-item>
				  <el-collapse-item v-if="infoForm.filterAuthorizeName.indexOf('ip') != -1">
					  <template #title>
					  	<el-tag type="warning">IP验证</el-tag>
					  </template>
					<div><el-tag  type="">ip={{infoForm.accessIp}}</el-tag></div>
				  </el-collapse-item>
				  <el-collapse-item v-if="infoForm.filterAuthorizeName.indexOf('parm') != -1">
					  <template #title>
					  	<el-tag type="warning">参数验证</el-tag>
					  </template>
					<div><el-tag  type="">{{infoForm.accessParameter}}</el-tag></div>
				  </el-collapse-item>
				  <el-collapse-item v-if="infoForm.filterAuthorizeName.indexOf('time') != -1">
					  <template #title>
					  	<el-tag type="warning">时间验证</el-tag>
					  </template>
					<div><el-tag  type="">时间区间：{{infoForm.accessTime}}</el-tag></div>
				  </el-collapse-item>
				  <el-collapse-item v-if="infoForm.filterAuthorizeName.indexOf('cookie') != -1">
					  <template #title>
					  	<el-tag type="warning">Cookie验证</el-tag>
					  </template>
					<div><el-tag  type="">{{infoForm.accessCookie}}</el-tag></div>
				  </el-collapse-item>
				</el-collapse>
			</el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;">
			...
			<el-col :span="18" class="gateway-info-value"><el-tag type="danger">{{infoForm.createTime}}</el-tag></el-col>
		</el-row>
		<el-row :gutter="24" style="border: 0px solid red;">
